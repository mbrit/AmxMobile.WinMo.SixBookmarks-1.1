...
namespace AmxMobile.WinMo.SixBookmarks
{
    public static class HttpHelper
    {
        ...
        private class DownloadXmlState
        {
            internal Action<XDocument> Callback;
            internal Failed Failed;

            internal void ReceiveHtml(string html)
            {
        ...
        internal static string CombineUrlParts(string a, string b)
        {
            return a + b;
        }
    }
